...
namespace WordUnscrambler
{
    class Constants
    {
        ...
        public const string EnterScrambledWordsManually = "Enter word(s) manually (seperated by comas if multiple): ";
        public const string EnterScrambledWordsOptionNotRecognised = "The option was not recognised.";

        public const string ErrorScrambledWordsCannotBeLoaded = "Scrambled words were not loaded becuase there was an error: ";
